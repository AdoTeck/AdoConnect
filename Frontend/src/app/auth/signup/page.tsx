...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-r from-indigo-100 to-teal-100 flex items-center justify-center px-4 py-8">
      <div
        className="max-w-5xl w-full bg-white rounded-2xl shadow-lg flex relative overflow-hidden"
        ref={containerRef}
      >
        {/* Left Section */}
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-[#229ABD] to-[#126D8F] p-12 items-center justify-center">
  ...
  return (
    <div className="space-y-2">
      ...
      <input
        ...
        value={value}
        onChange={onChange}
        className="mt-1 block w-full px-4 py-3 rounded-lg border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#229ABD] focus:border-[#229ABD] transition duration-300"
